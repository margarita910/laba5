...
/**
 * The class that reads the file and commands from the console.
 */
...
public class Reader {
    ...
    public Vector<Ticket> readFile() throws IOException{
        //Открываем файл.
    ...
    private boolean readFloat(String string){
        try{
    ...
    private boolean readDouble(String string){
        try{
    ...
    private boolean readInt(String string){
        try{
